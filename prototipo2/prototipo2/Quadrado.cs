...
namespace prototipo2
{
    public partial class Quadrado : UserControl
    {
        ...
        private void btnArea_Click(object sender, EventArgs e)
        {
            ...
            lblExplicacao.Text = "A área de um quadrado é calculada multiplicando dois de seus lados, ou seja: "+ Convert.ToString(lado1)+" + "+Convert.ToString(lado1)+" ou "+Convert.ToString(lado1)+" X 2.";
        }
