    ...
    public partial class Trapézio : UserControl
    {
        ...
        private void btnPedirBasetri2_Click(object sender, EventArgs e)
        {
            ...
            if (tipo == 1)
            {
                ...
                {
                    //senangulo1 = basetri1/lado1 -> basetri1 = senangulo1 * lado1
                    basetri2 = (Math.Sin(angulo2 - 90) * lado1);
                }
                else if (angulo3 != 0 && altura != 0)
                {
                    //tanangulo4 = altura/basetri1 -> tanangulo4*basetri1 = altura -> basetri1 = altura/tanangulo4
        ...
        private void btnExibirAltura_Click(object sender, EventArgs e)
        {
            ...
            if (tipo == 1 && angulo_visivel == true && divisao_visivel == true)
            {
                picTrapézio.Load("trapézio_isóceles_angulos_dividido.png");
            }
            else if (tipo == 1 && angulo_visivel == true && divisao_visivel == false)
            {
                picTrapézio.Load("trapézio_isóceles_altura_angulos.png");
            }
            else if (tipo == 1 && angulo_visivel == false && divisao_visivel == true)
            {
                picTrapézio.Load("trapézio_isóceles_dividido.png");
            }
            else if (tipo == 1 && angulo_visivel == false && divisao_visivel == false)
            {
        ...
        private void btnExibirAngulos_Click(object sender, EventArgs e)
        {
            ...
            if (tipo == 1 && altura_visivel == true && divisao_visivel == true)
            {
                picTrapézio.Load("trapézio_isóceles_angulos_dividido.png");
            }
            else if (tipo == 1 && altura_visivel == true && divisao_visivel == false)
            {
                picTrapézio.Load("trapézio_isóceles_altura_angulos.png");
            }
            else if (tipo == 1 && altura_visivel == false && divisao_visivel == true)
            {
                picTrapézio.Load("trapézio_isóceles_angulos_dividido.png");
            }
            else if (tipo == 1 && altura_visivel == false && divisao_visivel == false)
            {
        ...
        private void btnExibirDivisões_Click(object sender, EventArgs e)
        {
            ...
            if (tipo == 1 && altura_visivel == true && angulo_visivel == true)
            {
                picTrapézio.Load("trapézio_isóceles_angulos_dividido.png");
            ...
            else if (tipo == 1 && altura_visivel == true && angulo_visivel == false)
            {
                picTrapézio.Load("trapézio_isóceles_dividido.png");
            ...
            else if (tipo == 1 && altura_visivel == false && angulo_visivel == true)
            {
                picTrapézio.Load("trapézio_isóceles_angulos_dividido.png");
            ...
            else if (tipo == 1 && altura_visivel == false && angulo_visivel == false)
            {
                picTrapézio.Load("trapézio_isóceles_dividido.png");
        ...
        {
            if (lado1 != lado2 || angulo3 != angulo4 || angulo1 != angulo2)
            {
                this.tipo = 2;
            }
            else if (lado1 == lado2 || angulo3 == angulo4 || angulo1 == angulo2)
            {
                this.tipo = 1;
                if (basetri1 != 0)
                {
            ...
            if (tipo == 1) //isóceles
            {
                ...
                btnAltura.Location = new Point(345, 208);
                btnBasetri1.Location = new Point(101, 359);
                btnBasetri2.Location = new Point(612, 359);
                btnAngulo1.Location = new Point(205, 77);
                btnAngulo1.Size = new Size(29, 10);
                btnAngulo2.Location = new Point(487, 77);
                btnAngulo2.Size = new Size(29, 10);
        ...
        private void btnLimpar_Click(object sender, EventArgs e)
        {
             ...
             this.tipo = 1; //1 = isóceles | 2 = escaleno | 3 = retângulo
